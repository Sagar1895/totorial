package com.xworkz.tourism.entity.searchplace;
	...
	public class SearchPlaceEntity implements Serializable {
		@Id
		...
		public String toString() {
			return "SearchPlaceEntity [id=" + id + ", place=" + place + ", state=" + state + ", country=" + country
